...
int main() {
    ...
    while (true) {
        ...
        char d;  // we will ask the user if they want us to show how many words are remaining
        cout<<"Would you like us to show how many words are remaining (Y or N)?"<<endl;
        cin>>d;
        while (!game.is_won() && !game.is_lost()) {
            ...
            if( d=='Y'){ //if said yes before, we will show how many words are remaining as they proceed through the game. 
                cout<<"Number of words remaining "<<game.get_num_word_rem()<<endl; 
            }
            ...
            if (game.is_lost()) {
                ...
                cout<<"The secret word was "<< game.get_hidden_word()<<endl;
            }
        }
